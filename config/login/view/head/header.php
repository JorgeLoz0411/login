              ...
              <div class="logo">
                  <a href="#"><img src="/login/asset/img/Amarok.jpg" alt="Logo"></a>
                        ...
                        <style>
                            ...
                            body, .navbar, .navbar-brand, .nav-link, .boton {
                                font-family: 'Times New Roman', Times, serif;
                            }

                            /* Estilo para el enlace con la clase boton */
                            .boton, .navbar, .navbar-brand, .nav-link {
                            ...
                            .navbar-nav li a {
                                font-size: 12px; /* Tamaño de fuente reducido */
                                color: white; /* Texto en color aqua */
                                padding: 10px;
                            ...
                            .navbar-nav li a:hover {
                                border: 1px solid blue; /* Borde azul completo al hacer hover */
                                color: #00FFFF; /* Mantener el texto en color aqua */
                            }
                         </style>
            ...
            <div class="container">
                <article class="text-center">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-4">
                        <form action="https://formsubmit.co/jor0411loz@gmail.com" method="POST">
                                ...
                                <div class="container-fluid">
                                    <ul class="nav nav-pills">
                                        ...
                                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                            ...
                                            <li><a href="cuentas_apartados.php">Cuentas</a></li>
                                            <li><a href="marcas.php">Marcas</a></li>
                                            <li><a href="productos.php">Productos</a></li>
                                            <li><a href="productos_vendidos.php">Vendidos</a></li>
